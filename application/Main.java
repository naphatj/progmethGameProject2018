...
public class Main extends Application {
	...
	private  Font CHR_FONT = Font.font("Helveltica", 30);
	private  Font HP_FONT = Font.font("Helveltica", FontWeight.BOLD, 28);
	private  Font S_HP_FONT = Font.font("Helveltica", FontWeight.BOLD, 15);
	private  Font ACTION_FONT = Font.font("Helveltica", FontWeight.BOLD, 40);
	private  Font FIGHT_FONT = Font.font("Helveltica", 25);
	...
	private void initializeFightStage(Character c1,Monster m1,Monster m2,Monster m3,String background) {
		...
		b1.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				...
				if (!m1.isDead()) {
					m1.attack(c1);updateBattle(c1,m1,m2,m3,background);}
	...
	public void characterCreationScene() throws InterruptedException {
		...
		ngc.setFont(Font.font("Helveltica", 25));
